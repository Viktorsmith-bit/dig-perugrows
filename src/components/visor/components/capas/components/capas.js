...
export default function ListCapas(props){
    ...
    return(
        <div className='absolute-capas bg-white w-full md:w-96 lg:w-96 rounded-sm z-20 border border-gray-400 height-visor'>
            <div className='flex items-center gap-2 bg-green-700 px-3 h-10'>
                ...
                <h1 className='text-white'>Lista de capas</h1>
            </div>
            <div className='overFlow-hidden h-72 lg:h-96'>
                <div className='overflow-auto overscroll-auto h-72 lg:h-96 py-3'>
