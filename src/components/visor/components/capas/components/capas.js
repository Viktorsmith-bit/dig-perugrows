...
export default function ListCapas(props){
    ...
    return(
        <div className='absolute-capas bg-white w-full md:w-96 lg:w-96.5 rounded-sm border border-gray-400 height-visor ' style={{zIndex:"1000"}}>
            <div className='flex items-center justify-between bg-green-700 px-3 h-10 rounded-t-sm'>
            ...
            <div className='overFlow-hidden h-96'>
                <div className='overflow-auto overscroll-auto h-96 p-3'>
                    <h1 className='text-base text-color border-b-2 border-gray-600 pb-1'>Capas</h1>
                    <div className='flex gap-2 pt-2'>
                        <div className='flex gap-2'>
                            {props.state.corPeru === "openCorPeru" ?<div className='flex gap-2'><InputOpen/><h1 id="closeCorPeru" onClick={props.hundleClickEstadoVisor} className='text-sm cursor-pointer text-color'>Límites de cordilleras glaciares del Perú</h1></div>:
                            <div className='flex gap-2'><InputClose/><h1 id="openCorPeru" onClick={props.hundleClickEstadoVisor} className='text-sm cursor-pointer text-color'>Límites de cordilleras glaciares del Perú</h1></div>}
                        </div>
                    </div>
                    <div className='box -ml-1 pt-2'>
                        ...
                        }
                        {
                            amb?<div className='px-7 pt-1'>
                                ...
                                {props.state.corBlanca === "openCorBlanca" ?<div className='flex gap-1'><InputOpen /><h1 id="closeCorBlanca" onClick={props.hundleClickEstadoVisor} className='text-sm cursor-pointer text-color'>Unidades hidrográficas de cordillera Blanca</h1></div>:
                    ...
                    <div className='box -ml-1 pt-2'>
                        {glacLagu?<div className='flex gap-2'>
                                <svg onClick={hundleOpenGlacLagu} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#434040" className="cursor-pointer bi bi-caret-right-fill" viewBox="0 0 16 16">
                                    <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
                                </svg>
                                <h1 className='text-sm text-color cursor-pointer -ml-0.5' onClick={hundleOpenGlacLagu}>Inventario nacional de glaciares y lagunas de origen glaciar</h1>
                                </div>:<div className='flex gap-2'>
                                    <svg onClick={hundleCloseGlacLagu} xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#434040" className="cursor-pointer bi bi-caret-down" viewBox="0 0 16 16">
                                        <path d="M3.204 5h9.592L8 10.481 3.204 5zm-.753.659 4.796 5.48a1 1 0 0 0 1.506 0l4.796-5.48c.566-.647.106-1.659-.753-1.659H3.204a1 1 0 0 0-.753 1.659z"/>
                                    </svg>
                                    <h1 className='text-sm text-color cursor-pointer -ml-0.5' onClick={hundleCloseGlacLagu}>Inventario nacional de glaciares y lagunas de origen glaciar</h1>
                                </div>
                        }
                        {
                        ...
                        }
                        {
                            glacLagu?null:<Fragment>
                                <h1 className='px-7 pt-2 text-color text-xs'><span className='font-bold'>Fecha de los datos:</span> 2016</h1>
                                <h1 className='px-7 text-color text-xs'><span className='font-bold'>Fecha de publicación:</span> 2020</h1>
                                <h1 className='px-7 text-color text-xs'><span className='font-bold'>Créditos:</span> INAIGEM-SDIG</h1>
                                <h1 className='px-7 text-color text-xs'><span className='font-bold'>Fuente:</span> <a className='text-green-700 font-bold' target="_blank" href="https://visor.inaigem.gob.pe/">Geoportal INAIGEM</a></h1>
                            </Fragment>
                        }
                    </div>
