...
export default function Proyectos(){
    ...
    return(
        <div id='proyecto'>
            ...
            <div className='flex items-center items-center lg:h-screen py-10 lg:py-0 bg-gray-100'>
                <div className='flex w-full lg:flex-1 justify-center px-4 lg:px-0'>
                    <div className='w-full md:max-w-2xl lg:max-w-xl'>
                        ...
                        <h1 className='mt-5 text-justify text-color'>El permafrost podría representar una reserva de agua potencialmente significativa, donde, la contribución de agua dulce que proveen, probablemente aumente en el futuro a medida que los glaciares se retiren hacia elevaciones superiores y/o desaparezcan en respuesta al cambio climático. A pesar del potencial de este recurso, a la fecha en el Perú existen pocos estudios sobre su valoración como recurso hídrico y hace falta un inventario o mapa de su distribución nacional que sirva como insumopara la gestión de los recursos hídricos.
                        </h1>
                        <h1 className='mt-5 text-justify text-color'>El proyecto Permafrost tiene como objetivo principal identificar la distribución espacio temporal de permafrost en el Perú, adaptando y/o aplicando modelos matemáticos, usando imágenes satelitales y variables climáticas, con la finalidad de generar una base geoespacial que permita visualizar la distribución y formas del permafrost en el Perú y sea de utilidad para la gestión de territorio.</h1>
                        <button onClick={openModalResumen} className='px-5 lg:px-8 py-2 lg:py-3 border-color bg-color mt-5 rounded-md text-color'>Objetivos</button>
                    </div>
                </div>
                <div className='flex-1'>
                    <img className='cover h-screen hidden lg:block' src='/fondos/TrabajosCampo_Permafrost.jpeg' />
                    <h1></h1>
                </div>
            </div>
        </div>
