            ...
            <div className='flex items-center py-10 lg:py-0 bg-gray-100 height-section'>
                ...
                <div className='flex w-full lg:flex-1 justify-center px-4 lg:px-0'>
                    <div className='w-full md:max-w-2xl lg:max-w-xl'>
                        ...
                        <h1 className='mt-5 text-justify text-color'>La investigación se centró en la cuenca alta del río Santa, donde se buscó cubrir la brecha de información actual para lograr una eficiente gestión del recurso hídrico asociado a los cambios generados por los impactos del retroceso glaciar y el cambio climático.</h1>
                        <h1 className='mt-5 text-justify text-color'>Los trabajos de campo se realizaron en las unidades hidrográficas de Llullán, Ranrahirca, Ancash, Casca, Quillcay y Yanayacu en la cordillera Blanca. En el caso del modelamiento hidrológico se recopiló información general de las unidades hidrográficas Urpay, Huata, Santo Toribio y Utcuyacu en la cordillera Negra.</h1>
