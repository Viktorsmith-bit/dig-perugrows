    ...
    return(
        <div className='flex justify-center items-center lg:h-screen px-4 py-10 lg:px-0 lg:py-0 height-section'>
            <div className='flex flex-col items-center flex-1 w-full md:max-w-2xl lg:max-w-7xl w-full'>
                ...
                <h1 className=''></h1>
                <div className='flex flex-wrap justify-center lg:justify-between gap-3 mt-8 lg:mt-10 w-full'>
                    <div className=''>
                    ...
                    <div className=''>
                        <Link href='/produccion/cientifica'>
                            <a><img className='w-full md:w-80 lg:w-96 md:h-56 lg:h-72 cover' src='/fondos/Workshop_taller4.jpeg' /></a>
                        </Link>
                ...
                <Link href='/galeria'><a className='mt-7 lg:mt-10'><button className='w-56 py-4 border-color bg-color rounded-md text-color font-bold'>GALERÍA DE IMÁGENES</button></a></Link>
            </div>
        </div>
    );
}