...
import {listTeamNacional} from '../../../src/components/equipo/nacional/lista/lista.team.nacional';
                                    ...
                                    <div className='flex flex-col flex-1 w-full md:max-w-2xl lg:max-w-2xl'>
                                        ...
                                        <div className='footer mt-10 mr-auto'>
                                            <div className='flex flex-wrap redes gap-2'>
                                                ...
                                                <a href={item.pucp} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.pucp === null?'hidden':'block'} `}><h1>PUCP</h1></a>
                                                <a href={item.harvard} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.harvard === null?'hidden':'block'} `}><h1>Harvard</h1></a>
