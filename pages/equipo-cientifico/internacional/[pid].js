...
import {listTeamInternacional} from '../../../src/components/shared/equipoCientifico/nacional/listaJson/lista.team.modal';
                                    ...
                                    <img className='rounded-full w-40 h-40 lg:w-56 lg:h-56 cover-image border-2 border-white z-20' src={`${item.foto}`}/>   
                                        ...
                                        <div className='footer mt-10 mr-auto'>
                                            <div className='flex flex-wrap gap-2'>
                                                ...
                                                <a href={item.eclim} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.eclim === null?'hidden':'block'} `}><h1>EClim</h1></a>
                                                <a href={item.hud} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.hud === null?'hidden':'block'} `}><h1>University of Huddersfield</h1></a>
                                                <a href={item.edytem} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.edytem === null?'hidden':'block'} `}><h1>Edytem</h1></a>
                                                ...
                                                <a href={item.savoie} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.savoie === null?'hidden':'block'} `}><h1>Academia</h1></a>
                                                <a href={item.geocriologia} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.geocriologia === null?'hidden':'block'} `}><h1>AASP</h1></a>
